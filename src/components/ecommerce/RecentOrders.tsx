...
interface ScannerUser {
  ...
  status: "Active" | "Inactive" | "Expired"; // Status of the user
  lastActive: string; // Last active date
}

// Define the table data using the interface
const tableData: ScannerUser[] = [
  {
    id: 1,
    name: "John Smith",
            ...
            {tableData.map((user) => (
              <TableRow key={user.id} className="">
                <TableCell className="py-3">
                  <div className="flex items-center gap-3">
                    <div className="h-[50px] w-[50px] overflow-hidden rounded-full bg-brand-100 flex items-center justify-center">
